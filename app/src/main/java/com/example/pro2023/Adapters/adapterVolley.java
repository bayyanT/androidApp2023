...
public class adapterVolley extends ArrayAdapter<product> {
    ...
    public adapterVolley(Context context, List<product> products){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.card_orders,parent,false);
        }
